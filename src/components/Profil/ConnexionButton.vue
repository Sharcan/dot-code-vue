<template>
    <div id="ConnexionButton">
        <button class="link-button"> 
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30.581" viewBox="0 0 30 30.581">
                <path id="Icon_ionic-logo-google" data-name="Icon ionic-logo-google" d="M33.48,16.316l-.154-.654H19.1v6.022h8.5c-.882,4.191-4.978,6.4-8.324,6.4a9.954,9.954,0,0,1-6.7-2.669,9.563,9.563,0,0,1-2.853-6.75,9.863,9.863,0,0,1,2.8-6.743,9.529,9.529,0,0,1,6.654-2.6,8.68,8.68,0,0,1,5.662,2.206l4.279-4.257A15.141,15.141,0,0,0,19.039,3.382h0A15.584,15.584,0,0,0,8.009,7.867a15.521,15.521,0,0,0-4.353,10.8A15.365,15.365,0,0,0,7.84,29.294a15.961,15.961,0,0,0,11.507,4.669,14.2,14.2,0,0,0,10.338-4.346,15.264,15.264,0,0,0,3.971-10.574A17.606,17.606,0,0,0,33.48,16.316Z" transform="translate(-3.656 -3.382)" fill="currentColor"/>
            </svg>
